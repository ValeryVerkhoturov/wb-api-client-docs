...
Основной репозиторий хостит шесть языковых клиентов; в Go принято «один модуль на репозиторий», поэтому путь модуля включает под-каталог. Теги релизов покрывают все шесть языков одновременно — Go подхватывает нужный тег.
